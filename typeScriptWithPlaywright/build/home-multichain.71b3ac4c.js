...
`,D=t=>{var n,a,i;const{t:l}=(0,o.useTranslation)(),{showStakeAccountModalMultichain:s}=(0,x.useLegacyModals)(),{data:c}=(0,k.useFetchKeybaseUserAvatar)(t.keybaseUsername),d=null!==(a=null!==(n=t.name)&&void 0!==n?n:t.keybaseUsername)&&void 0!==a?a:(0,u.formatHashMedium)(t.voteAccountPubkey),g=y.hooks.useStakeActivationData(t.connection,t.pubkey).data,m=t.inflationReward&&t.inflationReward>0;return e(r).createElement(T,{onClick:()=>{s({stakeAccountPubkey:t.pubkey})}},e(r).createElement(A,{iconUrl:null!==(i=t.iconUrl)&&void 0!==i?i:c}),e(r).createElement(C,null,e(r).createElement(B,null,e(r).createElement(b.Text,{size:16,weight:600,lineHeight:19,textAlign:"left",noWrap:!0},d),e(r).createElement(b.Text,{size:14,weight:400,lineHeight:19,textAlign:"right",noWrap:!0},e(r).createElement(h.SolBalance,null,t.delegatedStake))),e(r).createElement(B,null,e(r).createElement(M,{size:14,activationState:null==g?void 0:g.state,lineHeight:19,textAlign:"left",textTransform:"capitalize",noWrap:!0},"activating"===(null==g?void 0:g.state)?l("stakeAccountListActivationActivating"):"","active"===(null==g?void 0:g.state)?l("stakeAccountListActivationActive"):"","inactive"===(null==g?void 0:g.state)?l("stakeAccountListActivationInactive"):"","deactivating"===(null==g?void 0:g.state)?l("stakeAccountListActivationDeactivating"):""),e(r).createElement(b.Text,{size:14,color:""+(m?"#21E56F":"#777777"),lineHeight:19,textAlign:"right",noWrap:!0},m?e(r).createElement(e(r).Fragment,null,"+",e(r).createElement(h.SolBalance,null,t.inflationReward)):"-"))))},F=t=>{const{t:n}=(0,o.useTranslation)(),{showStakeAccountModalMultichain:a}=(0,x.useLegacyModals)(),i=y.hooks.useStakeActivationData(t.connection,t.pubkey).data,l=t.inflationReward&&t.inflationReward>0;return e(r).createElement(T,{onClick:()=>a({stakeAccountPubkey:t.pubkey})},e(r).createElement(A,null),e(r).createElement(C,null,e(r).createElement(B,null,e(r).createElement(b.Text,{size:16,weight:600,lineHeight:19,textAlign:"left",noWrap:!0},t.pubkey),e(r).createElement(b.Text,{size:14,weight:400,lineHeight:19,textAlign:"right",noWrap:!0},e(r).createElement(h.SolBalance,null,t.balance))),e(r).createElement(B,null,e(r).createElement(M,{size:14,activationState:null==i?void 0:i.state,lineHeight:19,textAlign:"left",textTransform:"capitalize",noWrap:!0},"activating"===(null==i?void 0:i.state)?n("stakeAccountListActivationActivating"):"","active"===(null==i?void 0:i.state)?n("stakeAccountListActivationActive"):"","inactive"===(null==i?void 0:i.state)?n("stakeAccountListActivationInactive"):"","deactivating"===(null==i?void 0:i.state)?n("stakeAccountListActivationDeactivating"):""),e(r).createElement(b.Text,{size:14,color:""+(l?"#21E56F":"#777777"),lineHeight:19,textAlign:"right",noWrap:!0},l&&"+",e(r).createElement(h.SolBalance,null,t.inflationReward)))))},I=e=>{var t;const n=y.hooks.useValidators(e),a=null!==(t=n.results)&&void 0!==t?t:[],i=(0,r.useRef)(a);i.current=a;return(0,r.useMemo)((()=>new Map(i.current.map((e=>[e.voteAccountPubkey,e])))),[n.dataUpdatedAt,i])}})),n.register("k75bu",(function(a,i){t(a.exports,"ButtonUnwrapFungible",(function(){return f}));var l=n("43063"),o=n("29o0l"),r=n("gkfw3"),s=n("qppYH"),c=n("24y7X"),u=n("27SDj"),d=n("feAoQ");const g=(0,r.default)(c.TokenRowBody)`
  display: grid;
  grid-template-columns: 44px auto;
  column-gap: 10px;
  margin-bottom: 0;
