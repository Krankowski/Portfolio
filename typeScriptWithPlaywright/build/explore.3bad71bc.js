...
function e(e){return e&&e.__esModule?e.default:e}function t(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var n=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire1d24;n.register("b9OmH",(function(r,l){var i;i=r.exports,Object.defineProperty(i,"__esModule",{value:!0,configurable:!0}),t(r.exports,"default",(function(){return p}));var a=n("lBuGR"),o=n("lDSNw"),s=n("cZIbv"),c=n("agU8f"),d=n("cecAp");const u=s.default.div`
  padding-top: 16px;
`;var p=()=>{const{data:[t],isLoading:n}=(0,a.useFeatureFlags)(["enable-explore-page"]);return n?null:t?e(o).createElement(c.ExplorePage,null):e(o).createElement(u,null,e(o).createElement(d.Quests,null))}})),n.register("agU8f",(function(r,l){t(r.exports,"ExplorePage",(function(){return v}));var i=n("54qyi"),a=n("lBuGR"),o=n("egSKH"),s=n("lDSNw"),c=n("bjaYq"),d=n("lz7nT"),u=n("5Z2YQ"),p=n("cZIbv"),m=n("gMNJN"),x=n("iacGS"),f=n("d1qx3"),g=n("kn91D"),h=n("d2ZEW"),E=n("7YeH1"),b=n("bX0Oz"),w=n("eQuaH"),k=n("lsHq9");function v(){var t;m.hooks.useExploreLoadAllQueries();const n=(0,d.useLocation)(),{t:r}=(0,c.useTranslation)(),{data:[l]}=(0,a.useFeatureFlags)(["enable-quests"]),{error:p,refetch:g}=m.hooks.useQuests({platform:"extension",appVersion:(0,f.getManifestVersion)()}),{setActiveTab:v,activeTab:L}=(0,i.useExplore)();(0,s.useEffect)((()=>{var e;"quests"===(null===(e=n.state)||void 0===e?void 0:e.tab)&&l&&!p&&v(3)}),[null===(t=n.state)||void 0===t?void 0:t.tab,l,p,v]);const{error:D,refetch:N}=m.hooks.useLearn(),{error:P,refetch:T}=m.hooks.useExploreTokens(),{error:j,refetch:R}=m.hooks.useExploreSites(),{error:A,refetch:$}=m.hooks.useExploreCollections(),{error:M,refetch:F}=m.hooks.useExploreRecommendedTokens(),{error:z,refetch:O}=m.hooks.useExploreRecommendedSites(),{error:Z,refetch:_}=m.hooks.useExploreRecommendedCollections(),B=p&&D&&P&&j&&A&&M&&z&&Z,q=(0,s.useCallback)((()=>{l&&g(),T(),R(),$(),F(),O(),_(),N()}),[g,T,R,$,F,O,_,N,l]),[G,Q]=e(s).useState(""),U=(0,u.useDebouncedState)(G,250),X=e(o)((e=>{e&&x.exploreAnalytics.onExploreSearchedByUser({searchTerm:e})}),1e3);return(0,s.useEffect)((()=>{X(U)}),[U,X]),B?e(s).createElement(y,null,e(s).createElement(h.ExplorePageError,{title:r("exploreErrorTitle"),buttonText:r("exploreErrorButtonText"),description:r("exploreErrorDescription"),refetch:q})):e(s).createElement("div",null,e(s).createElement(b.ExploreSearchHeader,{value:G,onChange:Q}),e(s).createElement(S,{hide:!!U},e(s).createElement(k.ExploreTabs,null),e(s).createElement(E.Learn,null),1===L&&e(s).createElement(C,null,e(s).createElement(I,null,r("exploreTokensLegalDisclaimer")))),e(s).createElement(S,{hide:!U},e(s).createElement(w.ExploreSearchResults,{query:U})))}const y=p.default.div`
  padding: 16px;
`,S=p.default.div`
...
`,I=(0,p.default)(g.Text)`
  ...
  line-height: 16px;
  text-align: left;
`})),n.register("iacGS",(function(e,r){t(e.exports,"exploreAnalytics",(function(){return a}));var l=n("54qyi"),i=n("h5kyv");const a=new(0,l.ExploreAnalytics)(i.analytics)})),n.register("d2ZEW",(function(r,l){t(r.exports,"ExplorePageError",(function(){return h}));var i=n("lDSNw"),a=n("cZIbv"),o=n("44I6u"),s=n("aanFI"),c=n("6l2nq"),d=n("kn91D");const u=(0,a.default)(o.Column).attrs({align:"center"})``,p=a.default.div`
  width: 48px;
  height: 48px;
  position: relative;
  margin-bottom: 15px;
...
`,w=(0,s.default)(p.Text)`
  ...
  font-weight: 500;
  line-height: normal;
`,k=(0,s.default)(u.SkeletonLoader)`
  border-radius: 6px;
  height: 24px;
  width: 24px;
`,v=s.default.div`
...
`,x=({src:t,fallback:n,alt:r,size:l="normal",shape:a="circle",style:o})=>{const c=null!=n?n:e(i).createElement(f,null,"?"),x=u(l),g=u(l),h=(e=>"square"===e?6:0)(a);return"circle"===a?e(i).createElement(s.Circle,{color:"#222222",diameter:x,style:o},e(i).createElement(p,{src:t,fallback:c,alt:r||void 0,width:x,height:g,borderradius:h,loader:e(i).createElement(d.SkeletonLoader,{borderRadius:`${h}px`,width:`${x}px`,height:`${g}px`})})):e(i).createElement(m,{color:"#222222",width:x,height:g,style:o},e(i).createElement(p,{src:t,fallback:c,alt:r||"",width:x,height:g,borderradius:h,loader:e(i).createElement(d.SkeletonLoader,{borderRadius:`${h}px`,width:`${x}px`,height:`${g}px`})}))},f=o.default.div`
  ...
  align-items: center;
  justify-content: center;
`})),n.register("k1qXy",(function(e,r){t(e.exports,"useExploreSearchList",(function(){return c}));var l=n("54qyi"),i=n("4y59b"),a=n("gmVmN"),o=n("gMNJN"),s=n("GbSLs");const c=e=>{const t=o.hooks.useEnabledNetworkIDs(),{data:n,isLoading:r}=o.hooks.useRecommendedSearchSites({networkIds:t});return{dapps:(0,s.useFuse)(n||[],(0,a.removeWebPrefixes)(e),l.FUSE_EXPLORE_DAPPS_CONFIG).map((e=>Object.assign(Object.assign({},e),{href:(0,i.getOriginAndHostname)(e.domain).origin}))),isLoading:r}}})),n.register("GbSLs",(function(e,r){t(e.exports,"useFuse",(function(){return a}));var l=n("bEji2"),i=n("lDSNw");const a=(e,t,n)=>{const r=(0,i.useMemo)((()=>new(0,l.default)(e,n)),[e,n]);return(0,i.useMemo)((()=>t?r.search(t).map((e=>e.item)):e),[r,e,t])}})),n.register("lsHq9",(function(r,l){t(r.exports,"ExploreTabs",(function(){return I}));var i=n("54qyi"),a=n("lBuGR"),o=n("lMzyG"),s=n("lDSNw"),c=n("gMNJN"),d=n("iacGS"),u=n("d1qx3"),p=n("cecAp"),m=n("cA4t0"),x=n("5n3Kj"),f=n("jxADN"),g=n("Q6sgh"),h=n("l2FsX"),E=n("bxXOm"),b=n("adkwi"),w=n("efF5H"),k=n("ipUED"),v=n("7HoYh");const y=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreSites(),{isLoading:r}=c.hooks.useExploreSortOption();return e(s).createElement("div",null,e(s).createElement(f.CarouselSites,null),!t&&!r||n?e(s).createElement(h.default,{tab:"sites"}):e(s).createElement(E.ExploreFiltersSkeleton,null),e(s).createElement(w.ExploreListSites,null))},S=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreTokens(),{isLoading:r,currentSortOption:l}=c.hooks.useExploreSortOption(),i=l("tokens");return e(s).createElement("div",null,e(s).createElement(g.CarouselTokens,null),!t&&!r||n?e(s).createElement(h.default,{tab:"tokens"}):e(s).createElement(E.ExploreFiltersSkeleton,null),e(s).createElement(k.ExploreListTokens,{displayType:i}))},C=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreCollections(),{isLoading:r}=c.hooks.useExploreSortOption();return e(s).createElement("div",null,e(s).createElement(x.CarouselCollections,null),!t&&!r||n?e(s).createElement(h.default,{tab:"collections"}):e(s).createElement(E.ExploreFiltersSkeleton,null),e(s).createElement(b.ExploreListCollections,null))};function I(){const{activeTab:t,setActiveTab:n}=(0,i.useExplore)(),{t:r}=(0,o.useTranslation)(),{data:[l]}=(0,a.useFeatureFlags)(["enable-quests"]),{error:x}=c.hooks.useQuests({platform:"extension",appVersion:(0,u.getManifestVersion)()}),f=(0,s.useMemo)((()=>{const t=[{title:r("exploreApps"),name:"sites",element:e(s).createElement(y,null)},{title:r("exploreTokens"),name:"tokens",element:e(s).createElement(S,null)},{title:r("exploreCollections"),name:"collections",element:e(s).createElement(C,null)}];return l&&x?t:[...t,{title:r("quests"),name:"quests",element:e(s).createElement(p.Quests,{titleVisible:!1})}]}),[l,x,r]),g=(0,s.useMemo)((()=>f.map((e=>e.title))),[f]),h=(0,s.useMemo)((()=>f.map((e=>e.element))),[f]);return 0===f.length?null:e(s).createElement("div",null,e(s).createElement(v.default,{values:g,activeTabIndex:t,setActiveTabIndex:e=>{n(e),d.exploreAnalytics.onExploreTabClickedByUser({tabName:f[e].name})}}),e(s).createElement(m.default,{activeIndex:t,items:h}))}})),n.register("cecAp",(function(r,l){t(r.exports,"Quests",(function(){return h}),(function(e){return h=e}));var i=n("6Tvfa"),a=n("lMzyG"),o=n("bUo8j"),s=n("lDSNw"),c=n("cZIbv"),d=n("kn91D"),u=n("gMNJN"),p=n("d1qx3"),m=n("8XpGW"),x=n("k4rlt"),f=function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var l=0;for(r=Object.getOwnPropertySymbols(e);l<r.length;l++)t.indexOf(r[l])<0&&Object.prototype.propertyIsEnumerable.call(e,r[l])&&(n[r[l]]=e[r[l]])}return n};const g=e(s).memo((({quests:t,isLoading:n,titleVisible:r})=>{const{t:l}=(0,a.useTranslation)();return n?e(s).createElement("div",null,e(s).createElement(m.QuestSkeletonHeader,null),e(s).createElement(m.QuestSkeleton,null),e(s).createElement(m.QuestSkeleton,null)):e(s).createElement("div",null,r&&e(s).createElement(b,{size:22,weight:500},`${l("quests")} (${(0,o.getActiveQuestCount)(t)})`),e(s).createElement(x.QuestsList,{quests:t}))})),h=({titleVisible:t=!0})=>{const n=(()=>{const{data:e=[],isLoading:t,error:n}=u.hooks.useQuests({platform:"extension",appVersion:(0,p.getManifestVersion)()}),{data:r}=u.hooks.useSelectedMultiChainAccount(),{data:l}=u.hooks.useIsAnalyticsOptedOut();return(0,s.useMemo)((()=>({shouldShowQuests:!l&&(null==r?void 0:r.type)!==i.AccountType.ReadOnly&&!n,quests:e,isLoading:t})),[r,e,l,t,n])})(),{shouldShowQuests:r}=n,l=f(n,["shouldShowQuests"]);return r?e(s).createElement(E,{"data-testid":"quests"},e(s).createElement(g,Object.assign({},l,{titleVisible:t}))):null},E=c.default.div`
  padding: 16px;
  padding-top: 0;
...
`})),n.register("5n3Kj",(function(r,l){t(r.exports,"CarouselCollections",(function(){return p}));var i=n("lDSNw"),a=n("cZIbv"),o=n("gMNJN"),s=n("iacGS"),c=n("eIqd2"),d=n("4hpNE"),u=n("7Ed9h");function p(){var t;const{isLoading:n,error:r,data:l}=o.hooks.useExploreRecommendedCollections(),a=(0,i.useCallback)(((t,n)=>e(i).createElement(m,{href:t.marketplacePages[0].collectionUrl},e(i).createElement(u.CarouselCardContainer,{key:`carousel-card-collections-${n}`,onPress:()=>{s.exploreAnalytics.onExploreCarouselItemClickedByUser({datasourceId:(null==l?void 0:l.uuid)||"",carouselName:"collections",itemDetails:{position:n,title:t.name,id:t.id}})}},e(i).createElement(d.CarouselCardCollection,{collection:t})))),[null==l?void 0:l.uuid]);return e(i).createElement(c.default,{items:l?l.data:[],renderCard:a,isLoading:n,isEmpty:!(!r||(null==l?void 0:l.data)&&0!==(null===(t=null==l?void 0:l.data)||void 0===t?void 0:t.length))})}const m=a.default.a.attrs({target:"_blank",rel:"noopener noreferrer"})`
  text-decoration: none;
  display: contents;
`})),n.register("eIqd2",(function(r,l){t(r.exports,"default",(function(){return b}));var i=n("bK93X"),a=n("7dqns"),o=n("c1thM"),s=n("1bdlq"),c=n("8GcfJ"),d=n("lDSNw"),u=n("cZIbv"),p=n("iacGS"),m=n("aanFI"),x=n("kpwp2"),f=n("3Wzmm");const g=-1*(x.EXPLORE_CARD_SIZE+8),h={type:"spring",stiffness:256.1,damping:24,mass:1},E=2;function b({items:t,renderCard:n,isLoading:r,isEmpty:l}){const[o,u]=(0,d.useState)(0),[x,b]=(0,d.useState)(!1),S=(0,s.useMotionValue)(0),C=(0,d.useMemo)((()=>g*(t.length-E)),[t]),I=(0,d.useCallback)((e=>e<0?0:e>t.length-1?t.length-1:e),[t]),L=(0,d.useCallback)((()=>I(Math.round(S.get()/g))),[S,I]);(0,c.useMotionValueEvent)(S,"change",(()=>{u(L())}));const D=(0,d.useCallback)((e=>{const t=I(e)*g;(0,i.animate)(S,t,h),p.exploreAnalytics.onExploreCarouselDragged()}),[I,S]),N={fill:"#222",width:16,height:16};return r?e(d).createElement(f.CarouselSkeleton,null):l?null:e(d).createElement(w,null,e(d).createElement(a.AnimatePresence,{initial:!1},o>=1&&e(d).createElement(y,{onClick:()=>D(o-1)},e(d).createElement(m.IconArrowLeftThin,Object.assign({},N)))),e(d).createElement(a.AnimatePresence,{initial:!1},o<=t.length-E-1&&e(d).createElement(y,{isRight:!0,onClick:()=>D(o+1)},e(d).createElement(m.IconArrowRightThin,Object.assign({},N)))),e(d).createElement(k,{style:{x:S},drag:t.length>E?"x":void 0,dragConstraints:{left:C,right:0},onDragStart:()=>b(!0),onDragEnd:()=>{b(!1),D(L())}},t.map(((r,l)=>e(d).createElement(v,{key:`carousel-item-${l}`,isLast:l===t.length-1,onClick:e=>{x&&(e.stopPropagation(),e.preventDefault())},transition:{type:"spring",damping:20,stiffness:400,duration:.6,mass:1},whileHover:{scale:1.05}},n(r,l))))))}const w=u.default.div`
  width: 100vw;
  margin-bottom: 24px;
`,k=(0,u.default)(o.motion.div)`
  ...
  flex-direction: row;
  padding: 0 16px;
`,v=(0,u.default)(o.motion.div)`
  position: relative;
  margin-right: ${e=>e.isLast?0:8}px;
`,y=(0,u.default)(o.motion.div).attrs({transition:{ease:[.16,1,.3,1],duration:.5},initial:{opacity:0,translateY:8},animate:{opacity:1,translateY:0},exit:{opacity:0,translateY:8}})`
  background: #ab9ff2;
  width: 32px;
  height: 32px;
  border-radius: 50%;
...
`,f=a.default.div`
  ...
  flex-direction: column;
  justify-content: flex-end;
`})),n.register("4hpNE",(function(r,l){t(r.exports,"CarouselCardCollection",(function(){return u}));var i=n("4y59b"),a=n("3yHS8"),o=n("lDSNw"),s=n("gmVmN"),c=n("cZIbv"),d=n("4zbcJ");const u=({collection:t})=>{const n=(0,o.useMemo)((()=>{const n=new(e(a))(t.floorPrices[0].value,10).dividedBy(new(e(a))(10).pow(t.floorPrices[0].paymentToken.decimals)).toNumber();return`${(0,s.formatNumber)(n)} ${t.floorPrices[0].paymentToken.symbol} `}),[t.floorPrices]);return e(o).createElement(d.CarouselBackgroundImageCard,{src:t.imageUrl},e(o).createElement(p,null,e(o).createElement("div",null,e(o).createElement(m,null,(0,i.truncateString)(t.name,9)),e(o).createElement(x,null,n))))},p=c.default.div`
  width: 100%;
  padding: 8px 12px;
`,m=c.default.div`
  font-size: 18px;
...
`,x=c.default.div`
  ...
  font-size: 14px;
  line-height: 18px;
`})),n.register("4zbcJ",(function(r,l){t(r.exports,"CarouselBackgroundImageCard",(function(){return c}));var i=n("lDSNw"),a=n("cZIbv"),o=n("c6Gae"),s=n("kpwp2");const c=({src:t,children:n})=>e(i).createElement(e(i).Fragment,null,e(i).createElement(d,{src:t}),e(i).createElement(u,null,n)),d=(0,a.default)(o.PImage)`
  width: ${s.EXPLORE_CARD_SIZE_PX};
  height: ${s.EXPLORE_CARD_SIZE_PX};
  border-radius: 16px;
`,u=a.default.div`
...
`})),n.register("7Ed9h",(function(r,l){t(r.exports,"CarouselCardContainer",(function(){return s}));var i=n("lDSNw"),a=n("cZIbv"),o=n("kpwp2");function s({children:t,onPress:n}){return e(i).createElement(c,{onClick:n},t,e(i).createElement(d,null))}const c=a.default.div`
...
`,d=a.default.div`
  ...
  bottom: 0;
  cursor: pointer;
`})),n.register("jxADN",(function(r,l){t(r.exports,"CarouselSites",(function(){return m}));var i=n("4y59b"),a=n("lDSNw"),o=n("cZIbv"),s=n("gMNJN"),c=n("iacGS"),d=n("eIqd2"),u=n("7Ed9h"),p=n("jDR1u");function m(){var t;const{isLoading:n,error:r,data:l}=s.hooks.useExploreRecommendedSites(),o=(0,a.useCallback)(((t,n)=>e(a).createElement(x,{key:`carousel-card-sites-${n}`,href:(0,i.formatSearchURI)(t.domain)},e(a).createElement(u.CarouselCardContainer,{onPress:()=>{c.exploreAnalytics.onExploreCarouselItemClickedByUser({datasourceId:(null==l?void 0:l.uuid)||"",carouselName:"sites",itemDetails:{position:n,title:t.name,id:t.id}})}},e(a).createElement(p.CarouselCardSite,{site:t})))),[null==l?void 0:l.uuid]);return e(a).createElement(d.default,{items:l?l.data:[],renderCard:o,isLoading:n,isEmpty:!(!r||(null==l?void 0:l.data)&&0!==(null===(t=null==l?void 0:l.data)||void 0===t?void 0:t.length))})}const x=o.default.a.attrs({target:"_blank",rel:"noopener noreferrer"})`
  text-decoration: none;
  display: contents;
`})),n.register("jDR1u",(function(r,l){t(r.exports,"CarouselCardSite",(function(){return d}));var i=n("lMzyG"),a=n("lDSNw"),o=n("cZIbv"),s=n("c6Gae"),c=n("4zbcJ");const d=({site:t})=>{const{t:n}=(0,i.useTranslation)();return e(a).createElement(c.CarouselBackgroundImageCard,{src:t.backgroundImageUrl},e(a).createElement(u,null,e(a).createElement(x,null,e(a).createElement(p,null,t.name),e(a).createElement(m,null,n(`exploreCategory${t.category}`))),e(a).createElement(f,null,e(a).createElement(g,{src:t.imageUrl}))))},u=o.default.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
...
`,g=(0,o.default)(s.PImage)`
  ...
  height: 48px;
  border-radius: 14px;
`})),n.register("Q6sgh",(function(r,l){t(r.exports,"CarouselTokens",(function(){return p}));var i=n("lDSNw"),a=n("gMNJN"),o=n("iacGS"),s=n("1Eyg5"),c=n("eIqd2"),d=n("7Ed9h"),u=n("jtTSG");function p(){var t;const{isLoading:n,error:r,data:l}=a.hooks.useExploreRecommendedTokens(),p=(0,s.useExploreToSwap)(),m=(0,i.useCallback)(((t,n)=>e(i).createElement(d.CarouselCardContainer,{key:`carousel-card-token-${n}`,onPress:()=>{p(t),o.exploreAnalytics.onExploreCarouselItemClickedByUser({datasourceId:(null==l?void 0:l.uuid)||"",carouselName:"tokens",itemDetails:{position:n,title:t.tokens[0].data.name||t.id,id:t.id||""}})}},e(i).createElement(u.CarouselCardToken,{token:t}))),[null==l?void 0:l.uuid,p]);return e(i).createElement(c.default,{items:l?l.data:[],renderCard:m,isLoading:n,isEmpty:!(!r||(null==l?void 0:l.data)&&0!==(null===(t=null==l?void 0:l.data)||void 0===t?void 0:t.length))})}})),n.register("1Eyg5",(function(e,r){t(e.exports,"useExploreToSwap",(function(){return c}));var l=n("belzv"),i=n("gYh0e"),a=n("lDSNw"),o=n("lz7nT"),s=n("8182A");const c=()=>{const e=(0,o.useNavigate)();return(0,a.useCallback)((t=>{const n=(0,i.getFungibleCaip19FromFungible)(t.tokens[0]),r=(0,l.encodeCaip19)(n);e(`/${s.Path.Swap}?buyFungible=${r}`)}),[e])}})),n.register("jtTSG",(function(r,l){t(r.exports,"CarouselCardToken",(function(){return u}));var i=n("4y59b"),a=n("lDSNw"),o=n("gmVmN"),s=n("cZIbv"),c=n("c6Gae"),d=n("kpwp2");const u=({token:t})=>{const n=t.tokens[0];return e(a).createElement(p,null,e(a).createElement(m,null,e(a).createElement("div",null,e(a).createElement(g,null,(0,i.truncateString)(n.data.name||"",12)),e(a).createElement(h,null,n.data.symbol)),e(a).createElement(x,null,e(a).createElement(f,{src:n.data.logoUri||""}))),e(a).createElement("div",null,e(a).createElement(E,null,(0,o.formatDollarAmount)(parseFloat(t.currentPrice),{minimumAmount:1e-6,decimalFormatSmallNumbers:"0.[000000]",roundDecimals:!0})),e(a).createElement(b,{green:parseFloat(t.priceChangePercentage)>=0},(0,o.formatNumber)(parseFloat(t.priceChangePercentage),{includePlusPrefix:!0,suffix:"%"}))))},p=s.default.div`
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`})),n.register("l2FsX",(function(r,l){t(r.exports,"default",(function(){return h}));var i=n("belzv"),a=n("lBuGR"),o=n("lMzyG"),s=n("c1thM"),c=n("lDSNw"),d=n("cZIbv"),u=n("gMNJN"),p=n("a8kcR"),m=n("iacGS"),x=n("2tQxs"),f=n("aanFI");const g="200px";function h({tab:t}){const{data:n,mutate:r}=u.hooks.useExploreSelectedNetwork(),{currentSortOption:l,getSortOptions:i,setSortOption:a}=u.hooks.useExploreSortOption(),o=i(t),s=l(t);return e(c).createElement(k,null,e(c).createElement(w,{value:s,options:o,onChange:e=>{(e=>{a(t,e)})(e),m.exploreAnalytics.onExploreFilterChangedByUser({filterType:"sort",filterValue:e,listName:t})}}),e(c).createElement(b,{value:n,onChange:e=>{r(e),m.exploreAnalytics.onExploreFilterChangedByUser({filterType:"network",filterValue:e,listName:t})}}))}const E=({networkLabel:t,NetworkIcon:n})=>{const[r,l]=e(c).useState(!1);return e(c).createElement(y,{onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1)},e(c).createElement("span",{style:{color:r?p.theme.purple:p.theme.white}},t)," ",e(c).createElement(n,{width:20,height:20,fill:r?p.theme.purple:p.theme.white}))};function b({value:t,onChange:n}){const{t:r}=(0,o.useTranslation)(),{data:[l,s]}=(0,a.useFeatureFlags)(["enable-bitcoin","enable-bitcoin-explore"]),d=u.hooks.useEnabledNetworkIDs(),p=(0,c.useMemo)((()=>{const t=[];return d.includes(i.SolanaNetworkID.Mainnet)&&t.push({label:e(c).createElement(E,{networkLabel:"Solana",NetworkIcon:f.IconChainSolana}),key:"Solana",onClick:()=>n(i.SolanaNetworkID.Mainnet)}),d.includes(i.EthereumNetworkID.Mainnet)&&t.push({label:e(c).createElement(E,{networkLabel:"Ethereum",NetworkIcon:f.IconChainEthereum}),key:"Ethereum",onClick:()=>n(i.EthereumNetworkID.Mainnet)}),d.includes(i.PolygonNetworkID.Mainnet)&&t.push({label:e(c).createElement(E,{networkLabel:"Polygon",NetworkIcon:f.IconChainPolygon}),key:"Polygon",onClick:()=>n(i.PolygonNetworkID.Mainnet)}),l&&d.includes(i.BitcoinNetworkID.Mainnet)&&s&&t.push({label:e(c).createElement(E,{networkLabel:"Bitcoin",NetworkIcon:f.IconChainBitcoin}),key:"Bitcoin",onClick:()=>n(i.BitcoinNetworkID.Mainnet)}),t.length>1&&t.push({label:e(c).createElement(E,{networkLabel:r("exploreFilterByall_networks"),NetworkIcon:f.IconStackedLayers}),key:"all_networks",onClick:()=>n("all_networks")}),t}),[n,r,l,s,d]);return p.length>1?e(c).createElement(v,null,e(c).createElement(x.Dropdown,{items:p,dropdownWidth:g,dropdownItemPadding:"0"},e(c).createElement(S,null,e(c).createElement(C,null,(e=>{switch(e){case i.SolanaNetworkID.Mainnet:return"Solana";case i.EthereumNetworkID.Mainnet:return"Ethereum";case i.PolygonNetworkID.Mainnet:return"Polygon";case i.BitcoinNetworkID.Mainnet:return"Bitcoin";case"all_networks":return r("exploreFilterByall_networks");default:return""}})(t)),e(c).createElement(f.IconChevronDown,{width:12,height:12,fill:"#999999"})))):null}function w({options:t,value:n,onChange:r}){const{t:l}=(0,o.useTranslation)(),i=(0,c.useMemo)((()=>t.map((e=>({label:l(`exploreSortBy${e}`),key:e,onClick:()=>{r(e)}})))),[r,t,l]);return e(c).createElement(v,null,e(c).createElement(x.Dropdown,{items:i,dropdownWidth:g},e(c).createElement(S,{"data-testid":`exploreSortBy${n}-button`},e(c).createElement(C,null,l(`exploreSortBy${n}`)),e(c).createElement(f.IconChevronDown,{width:12,height:12,fill:"#999999"}))))}const k=d.default.div`
  display: flex;
  flex-direction: row;
...
`,C=d.default.div`
  ...
  font-size: 15px;
  font-weight: 600;
`})),n.register("bxXOm",(function(r,l){t(r.exports,"ExploreFiltersSkeleton",(function(){return s}));var i=n("lDSNw"),a=n("cZIbv"),o=n("hjnIF");function s(){return e(i).createElement(c,null,e(i).createElement(d,{width:"99px",height:"26px"}),e(i).createElement(d,{width:"124px",height:"26px"}))}const c=a.default.div`
  display: flex;
  flex-direction: row;
...
`,g=(0,a.default)(o.SkeletonLoader)`
  ...
  height: 48px;
  width: 48px;
`})),n.register("552ak",(function(r,l){t(r.exports,"ListItemCollection",(function(){return p}));var i=n("4y59b"),a=n("3yHS8"),o=n("lDSNw"),s=n("gmVmN"),c=n("cZIbv"),d=n("c6Gae"),u=n("hjnIF");const p=({collection:t,position:n})=>{const r=(0,o.useMemo)((()=>{const n=new(e(a))(t.floorPrices[0].value,10).dividedBy(new(e(a))(10).pow(t.floorPrices[0].paymentToken.decimals)).toNumber();return`${(0,s.formatNumber)(n)} ${t.floorPrices[0].paymentToken.symbol} `}),[t.floorPrices]),l=(0,o.useMemo)((()=>{const n=new(e(a))(t.volume||0,10).dividedBy(new(e(a))(10).pow(t.floorPrices[0].paymentToken.decimals)).toNumber();return`${(0,s.formatNumber)(n,{compact:n>=1e3})} ${t.floorPrices[0].paymentToken.symbol}`}),[t.volume,t.floorPrices]);return e(o).createElement(m,null,e(o).createElement(x,null,e(o).createElement(g,null,e(o).createElement(h,null,n)),e(o).createElement(v,{src:t.imageUrl,width:48,height:48,fallback:e(o).createElement(u.SkeletonLoader,{borderRadius:"14px",width:"48px",height:"48px"}),loader:e(o).createElement(u.SkeletonLoader,{borderRadius:"14px",width:"48px",height:"48px"})}),e(o).createElement("div",null,e(o).createElement(E,null,(0,i.truncateString)(t.name,15)),e(o).createElement(b,null,r))),e(o).createElement(f,null,e(o).createElement(w,null,l),e(o).createElement(k,{green:t.volumePercentChange>=0},(0,s.formatNumber)(t.volumePercentChange,{compact:!0,includePlusPrefix:!0}),"%")))},m=c.default.div`
  flex-direction: row;
  flex-wrap: nowrap;
  justify-content: space-between;
  gap: 10px;
...
`,k=c.default.div`
  ...
  color: ${e=>e.green?e.theme.green:e.theme.alert};
  text-align: right;
`,v=(0,c.default)(d.PImage)`
  border-radius: 14px;
  width: 48px;
  height: 48px;
`})),n.register("8jPdn",(function(r,l){t(r.exports,"ListItemContainer",(function(){return a}));var i=n("lDSNw");function a({children:t,onPress:n}){return e(i).createElement(o,{onClick:n},t)}const o=n("cZIbv").default.div`
  width: 100%;
  padding: 12px 16px;
`})),n.register("bU7ZE",(function(r,l){t(r.exports,"ListHeader",(function(){return o}));var i=n("lDSNw"),a=n("cZIbv");const o=({titles:t})=>e(i).createElement(s,null,e(i).createElement(c,null,e(i).createElement(p,null,e(i).createElement(u,null,t[0])),e(i).createElement(u,null,t[1])),e(i).createElement(d,null,e(i).createElement(u,null,t[2]))),s=a.default.div`
  flex-direction: row;
  width: 100%;
  justify-content: space-between;
  display: flex;
...
`,k=s.default.div`
  ...
  line-height: 20px;
  color: ${e=>e.green?e.theme.green:e.theme.alert};
`,v=(0,s.default)(c.PImage)`
  width: 48px;
  height: 48px;
  border-radius: 100px;
`,y=s.default.div.attrs({numberOfLines:1})`
  color: ${e=>e.theme.white};
  font-size: 12px;
`,S=s.default.div`
  width: 48px;
...
`,d=a.default.div`
  ...
  padding: 0 16px;
`}));
//# sourceMappingURL=explore.3bad71bc.js.map
