...
`,E=s.default.div`
  ...
  margin-bottom: 14px;
`,v=(0,s.default)(d.Text).attrs({size:16,color:"#777",weight:500,lineHeight:19,textAlign:"left"})``,y=(0,s.default)(d.Text).attrs((e=>({size:14,color:"#777",lineHeight:17,hoverColor:e.onClick?"#AB9FF2":void 0,weight:500,textAlign:"left",cursor:e.onClick?"pointer":void 0})))``,S=s.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  position: relative;
`,k=(0,s.default)(u.Circle).attrs({color:"#333333",diameter:40})`
  z-index: 0;
  cursor: pointer;
  &:hover:enabled {
    background: #444444;
...
`})),n.register("kUceD",(function(a,l){t(a.exports,"SwapperInput",(function(){return g}));var i=n("lDSNw"),r=n("cZIbv"),o=n("6EObQ"),s=n("aanFI"),u=n("jLA72"),c=n("02iAW"),d=n("kn91D");const p=r.default.div`
  display: flex;
  align-items: center;
  input {
    font-size: 34px;
...
`,w=r.default.div`
  display: flex;
  margin-right: 11px;
`,h=({assetButtonTitle:t,fungible:n,onClick:a,testID:l})=>{const{chain:r,logoUri:u,symbol:c,tokenAddress:d}=n.data;return e(i).createElement(b,{"data-testid":l,isClickable:void 0!==a,onClick:a},e(i).createElement(o.EcosystemImage,{image:{type:"fungible",src:u,fallback:c||d},size:30,tokenType:n.type,chainMeta:r}),e(i).createElement(f,null,t),void 0!==a&&e(i).createElement(w,null,e(i).createElement(s.IconChevronDown,{width:9,fill:"#fff"})))}})),n.register("aaN35",(function(a,l){t(a.exports,"LegacySwapWrapper",(function(){return p}));var i=n("belzv"),r=n("lMzyG"),o=n("lDSNw"),s=n("cZIbv"),u=n("gMNJN"),c=n("dXtR4");const d=s.default.div`
  overflow-y: inherit;
  padding-bottom: 15px;
`,p=e(o).memo((({children:t})=>{const n=u.hooks.useSelectedNetworks().every((e=>i.Chains.isMainnetNetworkID(e))),{t:a}=(0,r.useTranslation)(),l=(0,o.useMemo)((()=>({availableOnlyOnMainnet:a("swapAvailableOnMainnet")})),[a]);return n?e(o).createElement(d,null,t):e(o).createElement(c.SwapNotAvailableWrapper,{message:l.availableOnlyOnMainnet,swapDisabled:!0},t)}))})),n.register("dXtR4",(function(a,l){t(a.exports,"SwapNotAvailableWrapper",(function(){return b}));var i=n("a0t1u"),r=n("lDSNw"),o=n("kO1EB"),s=n("cZIbv"),u=n("kn91D");const c=s.default.div`
  overflow-y: "scroll";
  padding-top: 16px;
...
`,g=(0,s.default)(u.Text).attrs({size:14,lineHeight:19,weight:500,color:"#fff",textAlign:"left"})``,b=({message:t,swapDisabled:n=!0,children:a})=>((0,i.useResetSwapperOnMount)(),n?e(r).createElement(e(r).Fragment,null,e(r).createElement(p,{"data-testid":"disable-overlay"},e(r).createElement(m,null,e(r).createElement(g,null,t))),e(r).createElement(d,{"data-testid":"disable-wrapper"},a)):e(r).createElement(c,null,e(r).createElement(m,null,e(r).createElement(g,null,t)),e(r).createElement(e(r).Fragment,null,a)))})),n.register("6jRl8",(function(a,l){t(a.exports,"SwapReviewButton",(function(){return f}));var i=n("lBuGR"),r=n("lMzyG"),o=n("a0t1u"),s=n("lDSNw"),u=n("laYjG"),c=n("aXzxc"),d=n("gMNJN"),p=n("2LZGp");const m=()=>{const{t:t}=(0,r.useTranslation)();return e(s).createElement(u.Button,{type:"submit",theme:"default",disabled:!0},t("swapFlowActionButtonText"))},g=()=>{const{disabled:t,theme:n,title:a,onClick:l}=b();return e(s).createElement(u.Button,{type:"submit",theme:n,disabled:t,onClick:l},a)},b=()=>{const{t:e}=(0,r.useTranslation)(),{hasEnoughAssets:t,hasNoRoutes:n,canSwap:a,hasNoFundsForFees:l,sourceNativeToken:u}=d.hooks.useSwapReviewButtonProps(),m=(0,o.useSwapperStore)((e=>e.setQuoteFetchIntervalToggle)),{data:[g]}=(0,i.useFeatureFlags)(["enable-swapper-v3"]),{showSwapReviewModalMultichain:b}=(0,c.useLegacyModals)(),{handleShowModalVisibility:f}=(0,p.useModals)(),w=(0,s.useCallback)((()=>{l?f("insufficientBalance",{networkId:u.networkId,token:{balance:u.balance,required:u.required}}):(m(!1),g?f("swapReview"):b())}),[l,f,u.networkId,u.balance,u.required,m,g,b]);return a?{disabled:!1,theme:"primary",title:e("swapFlowActionButtonText"),onClick:w}:t?n?{disabled:!0,theme:"default",title:e("swapNoQuotesFound"),onClick:w}:{disabled:!0,theme:"default",title:e("swapFlowActionButtonText"),onClick:w}:{disabled:!0,theme:"warning",title:e("sendFormErrorInsufficientBalance"),onClick:w}},f=()=>{const{multichainQuoteResponse:t}=(0,o.useMultichainQuote)();return t?e(s).createElement(g,null):e(s).createElement(m,null)}})),n.register("4jukF",(function(a,l){t(a.exports,"default",(function(){return p}));var i=n("a0t1u"),r=n("lDSNw"),o=n("44I6u"),s=n("b9Eop"),u=n("pZwEX"),c=n("6jRl8"),d=n("gAONm");var p=()=>{const{multichainQuoteResponse:t,hasNoRoutes:n}=(0,i.useMultichainQuote)();return e(r).createElement(d.SwapWrapper,null,e(r).createElement(o.Column,{justify:"space-between",flex:1},e(r).createElement(o.Column,{align:"normal"},e(r).createElement(s.SwapSellAssetCard,null),e(r).createElement(s.SwapBuyAssetCard,null),t||n?e(r).createElement(u.SwapInfoCard,null):null),e(r).createElement(o.Column,null,t?e(r).createElement(c.SwapReviewButton,null):null)))}})),n.register("b9Eop",(function(a,l){t(a.exports,"SwapSellAssetCard",(function(){return w})),t(a.exports,"SwapBuyAssetCard",(function(){return E}));var i=n("lBuGR"),r=n("lMzyG"),o=n("lDSNw"),s=n("cZIbv"),u=n("miiws"),c=n("6EObQ"),d=n("aanFI"),p=n("kn91D"),m=n("aXzxc"),g=n("gMNJN"),b=n("fuIC6");const f=e(o).memo((({onClick:t})=>e(o).createElement(C,null,e(o).createElement(I,{onClick:t},e(o).createElement(d.IconArrowDownSquare,{fill:"#000000"}))))),w=()=>{const t=(()=>{const{t:e}=(0,r.useTranslation)(),{data:[t,n,a]}=(0,i.useFeatureFlags)(["enable-bridge-pairs","enable-next-jupiter-client","enable-native-bridge-pairs"]),l=g.hooks.useSwapSellAssetProps({enableBridgePairs:t,enableNextJupiterClient:n,enableNativeBridgePairs:a,isBalanceHidden:!1}),{showSwapSellAssetSelectModalMultichain:o}=(0,m.useLegacyModals)();return Object.assign(Object.assign({},l),{onSellAssetClicked:o,t:e})})();return e(o).createElement(h,Object.assign({},t))},h=e(o).memo((({assetButtonTitle:t,decimals:n,formattedMaxSellAmount:a,sellFungible:l,notEnoughAssets:i,hasMinimumSellAmount:r,uiSellAmount:s,onSellAssetClicked:u,setMaxSellAmount:p,updateSellAmount:m})=>{const{chain:g,logoUri:f,symbol:w,tokenAddress:h}=l.data;return e(o).createElement(y,{roundedTop:!0},e(o).createElement(F,{onClick:u},e(o).createElement(c.EcosystemImage,{image:{type:"fungible",src:f,fallback:w||h},size:44,tokenType:l.type,chainMeta:g}),e(o).createElement(T,null,e(o).createElement(k,null,l.data.name),e(o).createElement(A,null,l.data.symbol)),e(o).createElement(d.IconChevronDownThin,{fill:"#999999"})),e(o).createElement(M,null,e(o).createElement(b.SwapperInput,{dropdownTestID:"swap-sell-asset-dropdown",assetButtonTitle:t,decimals:n,disabled:!1,hasWarning:i||!r,fungible:l,isLoadingAmount:!1,isLoadingAssets:!1,onClick:u,onUserInput:m,value:s,maxSellAmount:a,setMaxSellAmount:p,fontSize:28})))})),x=e(o).memo((({t:t,assetButtonTitle:n,buyAmount:a,decimals:l,buyFungible:i,isFetchingQuote:r,onBuyAssetClicked:s,onSwitchTokens:u,currencyValue:p})=>{if(!i)return e(o).createElement(v,{t:t,onClick:s});const{chain:m,logoUri:g,symbol:w,tokenAddress:h}=i.data;return e(o).createElement(e(o).Fragment,null,e(o).createElement(f,{onClick:u}),e(o).createElement(y,{roundedBottom:!0},e(o).createElement(F,{onClick:s},e(o).createElement(c.EcosystemImage,{image:{type:"fungible",src:g,fallback:w||h},size:44,tokenType:i.type,chainMeta:m}),e(o).createElement(T,null,e(o).createElement(k,null,i.data.name),e(o).createElement(A,null,i.data.symbol)),e(o).createElement(d.IconChevronDownThin,{fill:"#999999"})),e(o).createElement(M,null,e(o).createElement(b.SwapperInput,{dropdownTestID:"swap-buy-asset-dropdown",assetButtonTitle:n,decimals:l,disabled:!0,hasWarning:!1,fungible:i,isLoadingAmount:r,isLoadingAssets:!1,onClick:s,onUserInput:()=>{},value:a,currencyValue:p,fontSize:28}))))})),E=()=>{const t=(()=>{const{t:e}=(0,r.useTranslation)(),{showSwapBuyAssetSelectModalMultichain:t}=(0,m.useLegacyModals)(),n=(0,o.useCallback)((()=>{t()}),[t]),a=g.hooks.useSwapBuyAssetProps();return Object.assign(Object.assign({},a),{onBuyAssetClicked:n,t:e})})();return e(o).createElement(x,Object.assign({},t))},v=({t:t,onClick:n})=>e(o).createElement(e(o).Fragment,null,e(o).createElement(f,null),e(o).createElement(S,{onClick:n},e(o).createElement(F,null,e(o).createElement(B,null,e(o).createElement(d.IconPlusThin,{width:20})),e(o).createElement(T,null,e(o).createElement(A,{size:16,weight:600},t("swapSelectToken")))))),y=s.default.div`
  ...
  padding: 8px;
`,S=(0,s.default)(y).attrs({roundedBottom:!0})`
  cursor: pointer;
`,k=(0,s.default)(p.Text).attrs({size:16,color:"#FFF",weight:600,lineHeight:19,textAlign:"left"})``,A=(0,s.default)(p.Text).attrs((e=>({size:e.size||14,color:"#777",weight:e.weight||400,lineHeight:17,textAlign:"left"})))``,C=s.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  position: relative;
...
`,M=s.default.div`
  padding: 0 0 8px 8px;
`})),n.register("fuIC6",(function(a,l){t(a.exports,"SwapperInput",(function(){return m}));var i=n("lMzyG"),r=n("lDSNw"),o=n("cZIbv"),s=n("jLA72"),u=n("hjnIF"),c=n("kn91D");const d=o.default.div`
  display: flex;
  align-items: center;
  height: 36px;
  input {
...
`})),n.register("gAONm",(function(a,l){t(a.exports,"SwapWrapper",(function(){return p}));var i=n("belzv"),r=n("lMzyG"),o=n("lDSNw"),s=n("cZIbv"),u=n("gMNJN"),c=n("dXtR4");const d=s.default.div`
  display: flex;
  flex: 1;
  padding-bottom: 16px;
